...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // getSupportActionBar().setTitle("Login");
        ...
        Button buttonRegisterActivity = findViewById(R.id.button_register_activity);
    ...
    private void showAlertDialog() {
        ...
        builder.setPositiveButton("Continue", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK); //To email app in new window and not in within our app
                startActivity(intent);
            }
        });
    ...
    //Check user is already logged in. In such case, straightaway take the user to user's profile.
    @Override
